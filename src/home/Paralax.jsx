...
const SlideList = [
  {
    ...
    category: "",
    title: "Mian technical",
    description:
      "Empower businesses with cutting-edge IT & Engineering solutions.",
    buttonText: "Contact Us",
    buttonLink: "/contact",
  },
];

import sliderImage from "../assets/images/bg/bg-image-main.png";

import image1 from "../assets/images/bg/paralax/adrien-olichon-RCAhiGJsUUE-unsplash.jpg";
import image2 from "../assets/images/bg/paralax/bg-image-3.jpg";
import image3 from "../assets/images/bg/bg-image-main.png";
              ...
              <div className="row align-items-center">
                <div className="col-lg-12">
                  <div className="section-title service-style--2 text-center mb--30 mb_sm--0">
                    <h2>Our Service</h2>
                    <p>
                    We provide cutting-edge IT & engineering services tailored to your needs.
                    </p>
                  </div>
                </div>
              </div>
